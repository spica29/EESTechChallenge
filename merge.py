...
refTempL = pd.read_csv('sklop_1/learning_set_1/Log_R3063_CU_THS_SP_AS_filtered.csv')
realTempL = pd.read_csv('sklop_1/learning_set_1/Log_R3063_CU_THS_PV_AS_filtered.csv')
balcDoorL = pd.read_csv('sklop_1/learning_set_1/Log_R3063_CU_BLC_DR_DS_filtered.csv')
cabineL = pd.read_csv('sklop_1/learning_set_1/Log_R3063_CU_GST_INOUT_DS_filtered.csv')
