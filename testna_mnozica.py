...
df1_filtered.to_csv("ucna_mnozica_1/testna_mnozica/Log_R3063_CU_BLC_DR_DS_isfiltrirano.csv", index=False)
df2_filtered.to_csv("ucna_mnozica_1/testna_mnozica/Log_R3063_CU_FCU_CV_PV_AS_isfiltrirano.csv", index=False)
df3_filtered.to_csv("ucna_mnozica_1/testna_mnozica/Log_R3063_CU_FCU_HE_PV_AS_isfiltrirano.csv", index=False)
df4_filtered.to_csv("ucna_mnozica_1/testna_mnozica/Log_R3063_CU_GST_INOUT_DS_isfiltrirano.csv", index=False)
df5_filtered.to_csv("ucna_mnozica_1/testna_mnozica/Log_R3063_CU_THS_PV_AS_isfiltrirano.csv", index=False)
df6_filtered.to_csv("ucna_mnozica_1/testna_mnozica/Log_R3063_CU_THS_SP_AS_isfiltrirano.csv", index=False)