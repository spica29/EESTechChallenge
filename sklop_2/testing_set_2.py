...
df1_filtered.to_csv("learning_set_2/testing_set/Log_R3065_CU_FCU_CV_PV_AS_filtered.csv", index=False)
df4_filtered.to_csv("learning_set_2/testing_set/Log_R3065_CU_FCU_HE_PV_AS_filtered.csv", index=False)
