...
refTempL = pd.read_csv('Log_R3063_CU_THS_SP_AS_filtered.csv')
realTempL = pd.read_csv('Log_R3063_CU_THS_PV_AS_filtered.csv')
balcDoorL = pd.read_csv('Log_R3063_CU_BLC_DR_DS_filtered.csv')
cabineL = pd.read_csv('Log_R3063_CU_GST_INOUT_DS_filtered.csv')
...
c.to_csv("dataLeft_testing.csv", index=False)
