...
df1_filtered.to_csv("learning_set_2/Log_R3065_CU_BLC_DR_DS_filtered.csv", index=False)
df4_filtered.to_csv("learning_set_2/Log_R3065_CU_GST_INOUT_DS_filtered.csv", index=False)
df5_filtered.to_csv("learning_set_2/Log_R3065_CU_THS_PV_AS_filtered.csv", index=False)
df6_filtered.to_csv("learning_set_2/Log_R3065_CU_THS_SP_AS_filtered.csv", index=False)